...
var a=this.input.value,b=a.substr(0,4)+// years
"-"+a.substr(5,2)+// months
"-"+a.substr(8,2)+// days
"T"+a.substr(11,2)+// hours
":"+a.substr(14,2)+// minutes
":"+this.datetimeInfo.date.getSeconds()+// seconds
"."+this.datetimeInfo.date.getMilliseconds()+//secfrac
this.datetimeInfo.timezone;return b}return this._super()},setValue:function(a,b,c){if("date-time"===this.format){
// deal with timezone and all date-time issues
a=a.trim();var d="";"Z"===a.substr(a.length-1)?d=a.substr(a.length-1):"+"!==a.substr(a.length-6)&&"-"!==a.substr(a.length-6)||(d=a.substr(a.length-6));var e=new Date(a);return this.input.value=e.getFullYear()+"-"+e.getMonth()+"-"+e.getDay()+"-T"+e.getHours()+":"+e.getMinutes(),void(this.datetimeInfo={date:e,timezone:d})}if((!this.template||c)&&(null===a||"undefined"==typeof a?a="":"object"==typeof a?a=JSON.stringify(a):"string"!=typeof a&&(a=""+a),a!==this.serialized)){
